...
@Component({
  selector: 'app-transaction-modal-delete-template',
  imports: [CommonModule, FormsModule],
  standalone: true,
  templateUrl: './transaction-modal-delete-template.component.html',
  styleUrl: './transaction-modal-delete-template.component.scss'
})
export class TransactionModalDeleteTemplateComponent {
